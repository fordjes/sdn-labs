...
0. Now lets review the icons. From top to bottom...
    ...
    ![Alta3 Research MiniEdit](https://alta3.com/labs/images/alta3_miniedit08.png)
...
0. **Check** *Start CLI*.
    ...
    ![Alta3 Research MiniEdit Preferences](https://alta3.com/labs/images/alta3_miniedit07.png)
...
0. Click the **Restart Capture** button in Wireshark (choose *No* if prompted to save your old capture).
    ...
    ![Alta3 Research MiniEdit Restart Capture](https://alta3.com/labs/images/alta3_miniedit06.png)
