...
### Lab Objective
The objective of this lab is to learn in detail what a *topology* is. You will look at a topology file and see exactly how a topology is encoded in Mininet using Python. This is an optional lab, but there are downloads available so you can download the "answers" and study how topologoies are encoded without actually writing the code yourself. This lab is essential for advanced students and if intermediate or new students want to do this lab, just download and study the topologies that we wrote for you rather thatn trying to write the topology yourself.
