...
0. Boot a cirros machine called *my_guest_os*

    `student@controller (admin) :~$` `openstack server create --image cirros --flavor m1.tiny --nic net-id=demo-net my_guest_os`
