...
0. Good job! You've opened a packet capture containing the OpenFlow protocol. Right now, our focus is how to use Wireshark, but we seem to be on the right track.
