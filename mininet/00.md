...
0. Click the **OK** button again to finish setting a color filter for the OpenFlow protocol.
  ...
  ![Alta3 Research Wireshark OpenFlow Color](https://alta3.com/labs/images/alta3_sdn_wireshark13.png)
...
0.	*Left-click* on packet “No. 1” if it is not still highlighted.
