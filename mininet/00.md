...
0. **HOW TO MAKE A LIVE CAPTURE**

0.	Close Wireshark by clicking the “X” in the right corner, or selecting: File > Quit

0.	On the Desktop, at the bottom of the screen, locate the quick launch Wireshark icon (it looks like a little blue shark fin). Click 
this icon.

0.	In the center left of the screen is a large green sharkfin icon, and a list of interfaces below it

0.	Click on the interface ‘any’

0.	Now click on the green sharkfin icon to start a trace

0.	Click the red Stop button to stop the trace
